...
const ChaptersPage = () => {
  ...
  const getChaptersForSubject = () => {
    ...
    if (decodedSubject === 'Agriculture' && grade === '11') {
      const agriculture = grade11Subjects.find(s => s.name === 'Agriculture');
      const chaptersList = agriculture?.chapters || [];
      return chaptersList.map((chapterName, index) => {
        ...
        return {
          id: index + 1,
          title: chapterName,
          description: getGrade11AgricultureUnitDescription(chapterName),
          duration: getDurationEstimate(questions.length),
          difficulty: getDominantDifficulty(easyQuestions, mediumQuestions, hardQuestions),
          progress: Math.floor(Math.random() * 101),
          isCompleted: Math.random() > 0.7,
  ...
  const getGrade11AgricultureUnitDescription = (unitName: string) => {
    const descriptions: { [key: string]: string } = {
      "Unit 1: Introduction to Crop Production": "Principles of crop cultivation, site selection, soil preparation, planting, and harvesting",
      "Unit 2: Field Crops Production and Management": "Cultivation practices for cereals and legumes, field operations, and post-harvest handling",
      "Unit 3: Industrial Crops Production and Management": "Production of cash crops like cotton and oilseeds, quality standards, and processing needs",
      "Unit 4: Introduction to Farm Animals": "Overview of livestock species, roles in farming systems, and basic husbandry",
      "Unit 5: Animal Feeds and Feeding Practices": "Feed classification, ration formulation, and feeding strategies for productivity",
      "Unit 6: Animal Genetics and Breeding Practices": "Genetic principles, selection methods, crossbreeding, and improvement programs",
      "Unit 7: Farm Animals Housing": "Design, hygiene, ventilation, space requirements, and biosecurity in housing",
      "Unit 8: Basic Animal Health and Disease Control": "Disease signs, prevention, vaccination, sanitation, and quarantine measures",
      "Unit 9: Dairy Cattle Production and Management": "Dairy breeds, milking hygiene, calf rearing, nutrition, and herd health",
      "Unit 10: Introduction to Natural Resources": "Types of resources, renewable vs non-renewable, and sustainable use concepts",
      "Unit 11: Management of Natural Resources": "Watershed, soil, and water conservation, afforestation, and community management",
      "Unit 12: Concepts of Biodiversity": "Levels of biodiversity, threats, conservation methods, and ecosystem services",
      "Unit 13: Climate Change Adaptation and Mitigation": "Impacts on agriculture, adaptation options, and emission reduction strategies",
      "Unit 14: Mechanized Farming": "Machinery types, selection, maintenance, and effects on labor and soil",
      "Unit 15: Introduction to Human Nutrition": "Nutrients, diet diversity, deficiencies, and nutrition-sensitive agriculture",
      "Unit 16: Diversified Food Production and Consumption": "Diversification strategies, home gardens, and links to food security and health",
    };
    return descriptions[unitName] || "Comprehensive study of agricultural units and practices";
  };
  ...
  const isGrade11Agri = decodedSubject === 'Agriculture' && grade === '11';
  const unitLabel = isGrade11Agri ? 'Unit' : 'Chapter';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">
            {decodedSubject} {unitLabel}s
          </h1>
          <p className="text-xl text-blue-200 mb-6">
            Grade {grade} • Choose a {unitLabel.toLowerCase()} to start your quiz
          </p>
